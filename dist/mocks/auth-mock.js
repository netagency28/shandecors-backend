...
exports.mockAuth = exports.mockUsers = void 0;
...
exports.mockAuth = {
    async signIn(email, password) {
        const user = exports.mockUsers.find(u => u.email === email && u.password === password);
        if (!user) {
    ...
    async signUp(email, password, name) {
        if (exports.mockUsers.find(u => u.email === email)) {
